<template>
  <div id="invoice">
    <h1 class="ui dividing red header">Invoice</h1>
      ...
      <form class="ui form">
        ...
        <div class="two fields">
          <div class="field">
            <label>Name</label>
            <div class="field">
              <input type="text" name="shipping[first-name]" placeholder="Name" v-model="invoice.name">
            </div>
          </div>
          <div class="field">
            <label>Email</label>
            <div class="field">
              <input type="text" name="email" placeholder="Email" v-model="invoice.email">
            </div>
          </div>
        </div>
        <div class="field">
          ...
          <div class="fields">
            <div class="twelve wide field">
              <input type="text" name="address.street" placeholder="Street Address" v-model="invoice.address.street">
            </div>
            <div class="four wide field">
              <input type="text" name="address.number" placeholder="Apt #" v-model="invoice.address.number">
            </div>
          </div>
        </div>
        <div class="two fields">
          <div class="field">
            ...
            <div class="ui fluid search selection dropdown">
              <input type="hidden" name="country" v-model.lazy="invoice.country">
        ...
        <div class="field">
          ...
          <div class="ui selection dropdown">
            <input type="hidden" name="card.type" v-model.lazy="invoice.card.type">
        ...
        <div class="fields">
          <div class="seven wide field">
            ...
            <input type="text" name="card[number]" maxlength="16" placeholder="Card #" v-model="invoice.card.number">
          </div>
          <div class="three wide field">
            <label>CVC</label>
            <input type="text" name="card[cvc]" maxlength="3" placeholder="CVC/CVV" v-model="invoice.card.cvc">
          </div>
          <div class="six wide field">
            <label>Expiration</label>
            <div class="two fields">
              <div class="field">
                <select class="ui fluid search dropdown" name="card[expire-month]" v-model="invoice.card.expire.month">
              ...
              <div class="field">
                <input type="text" name="card[expire-year]" maxlength="4" placeholder="Year"
                       v-model="invoice.card.expire.year">
              </div>
            </div>
          </div>
        </div>

        <h4 class="ui dividing red  header">Total</h4>
        <div class="field">
          <input type="text" name="invoice.total" maxlength="6" placeholder="0.00"
        ...
        <div class="ui segment">
          <div class="field">
            <div class="ui toggle checkbox">
              <input type="checkbox" name="invoiced" tabindex="0" class="hidden" v-model="invoice.invoiced">
              <label>Mark as invoiced.</label>
            </div>
          </div>
        </div>

        <br/>
        <div class="ui big green button" tabindex="0" v-on:click="save">Add Order</div>
      </form>
    </div>
    <br/>
  </div>
...
<script>
  ...
  export default{
    ...
    methods: {
      ...
      semantize() {
        console.log('Enabling Semantic-UI');
